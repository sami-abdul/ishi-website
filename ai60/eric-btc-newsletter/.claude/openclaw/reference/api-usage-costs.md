...
This documentation outlines **features that can invoke API keys** and where their costs appear. It emphasizes OpenClaw features that can generate provider usage or paid API calls.
