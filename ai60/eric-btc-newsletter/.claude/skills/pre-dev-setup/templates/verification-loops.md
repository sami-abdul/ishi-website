...
3. Verify `openclaw.json` has sandbox enabled for all non-orchestrator agents
...
6. Test agent responds via channel after deployment

### Agent Workspace Verification

For each new or modified agent workspace:
